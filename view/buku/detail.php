...
<div class="card card-success">
    ...
    <div class="card-body">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="pengarang" name="pengarang" disabled
                value="<?=$data['pengarang'] ?>">
        </div>
        <div class="form-group">
            <label for="penerbit">Penerbit</label>
            <input type="text" class="form-control" id="penerbit" name="penerbit" disabled
                value="<?=$data['penerbit'] ?>">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="date" class="form-control" id="tanggalcatat" name="tanggalcatat" disabled
                value="<?=$data['tanggalcatat'] ?>">
        </div>
        <div class="form-group">
            <label for="idpegawai">Id pegawai</label>
            <input type="text" class="form-control" id="idpegawai" name="idpegawai" disabled
                value="<?=$data['idpegawai'] ?>">
        </div>
